...
public class DataExchange {
	...
	public static final int OTHER4_CMD  = 23;
	...
	public static final int MIN_FRM_RADIUS = (50)/2;	 
	public static final int MAX_FRM_RADIUS = (90+150)/2; 
	...
	public void encodeNxtOpcode() {
		...
		//nxtOpcode = nxtPos + nxtSpeed*MLTP + nxtDyntag*MLTP*MLTP + nxtCmd*MLTP*MLTP*MLTP;
	}	
	...
	public void set_debugText(String text) {
		this._debugText = this._debugText + "\n" + text;
	}
	
	public void reset_debugText() {
		this._debugText = "\n";
	}
};